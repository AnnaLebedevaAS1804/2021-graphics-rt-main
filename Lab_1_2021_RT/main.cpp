...
void create_scene()
{
  ...
  auto plane = std::make_shared<Plane>(float3(+0.0f, +0.0f, +0.0f), float3(0.0f, 1.0f, 0.0f), new IdealMirror(float3(250 / float(255), 235 / float(255), 215 / float(255))));
  ...
  auto parallel = std::make_shared<Parallel>(float3(-10.0f, +2.0f, -2.0f), float3(-5.0f, +7.0f, +5.0f), new Diffuse(float3(0.0f, 0.5f, 1.0f)));
  ...
  auto tr = std::make_shared<Triangle>(float3(+7.0f, +5.0f, -5.0f), float3(+5.0f, +10.0f, 0.0f), float3(+10.0f, +3.0f, -5.0f), new Diffuse(float3(250 / float(255), 69 / float(255), 0 / float(255))));
